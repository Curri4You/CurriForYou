...
public class GmActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    String REQUEST_URL_GRADE_LIST[] = {REQUEST_URL_GRADE0, REQUEST_URL_GRADE1, REQUEST_URL_GRADE2, REQUEST_URL_GRADE3,
            REQUEST_URL_GRADE4, REQUEST_URL_GRADE5, REQUEST_URL_GRADE6};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //
        for (int i=0; i<2; i++){
            getData_Grade(REQUEST_URL_GRADE_LIST[i], i);
        }
        /*getData_Grade(REQUEST_URL_2019_1, 0);
        getData_Grade(REQUEST_URL_2019_2, 1);*/
        ...
        tv_totalGrade_list[2] = findViewById(R.id.gm_list_totalGrade2);
    ...
    /////////////////////////////////////////////////////////////////
    private void getData_Grade(String Request_url, int num_semester) {
        Thread thread = new Thread(new Runnable() {
            @Override
            public void run() {
                String result;
                ...
                //파싱 기능 사용
                RC_jsonParser_Grade(result, num_semester);
            }
        });
        thread.start();
    }
    ...
    //[RecyclerView] jsonParser 함수
    //웹사이트 화면을 파싱하는 함수
    public void RC_jsonParser_Grade(String jsonString, int num_semester) {
        ...
        try {
            ...
            for (int i = 0; i < gmSemester.length(); i++) {
                ...
                double sum_grade_ver1_all, sum_grade_ver1_major, sum_grade_ver1_liber,
                        sum_grade_ver2_all, sum_grade_ver2_major, sum_grade_ver2_liber,
                        sum_grade_ver3_all, sum_grade_ver3_major, sum_grade_ver3_liber,
                        sum_credit_all, sum_credit_major, sum_credit_liber;
                double avg_ver1_all, avg_ver1_major, avg_ver1_liber, avg_ver2_all, avg_ver2_major, avg_ver2_liber, avg_ver3_all, avg_ver3_major, avg_ver3_liber;
                ...
                /*tv_totalGrade_list[3].setText("test");*/

                //[총 평점]
                sum_grade_ver1_all = Double.parseDouble(gmSemesterInfo.getString("sum_grade_ver1_all"));
                ...
                //[전공 평점]
                sum_grade_ver1_major = Double.parseDouble(gmSemesterInfo.getString("sum_grade_ver1_major"));
                ...
                //[교양 평점]
                sum_grade_ver1_liber = Double.parseDouble(gmSemesterInfo.getString("sum_grade_ver1_liber"));
