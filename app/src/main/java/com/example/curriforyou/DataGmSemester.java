...
public class DataGmSemester {
//semester(학기), totalGrade(총 학점), majorGrade(전공학점), liberalGrade(교양학점)
    String semester, totalGrade, majorGrade, liberalGrade;

    public DataGmSemester(String semester, String totalGrade, String majorGrade, String liberalGrade){
